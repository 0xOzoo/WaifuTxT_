        ...
        {!isRecording && (
          <div className="relative flex-shrink-0">
            <button
              ...
              className={`p-3 transition-colors cursor-pointer ${showPlusMenu ? 'text-accent-pink' : 'text-text-muted hover:text-text-primary'}`}
            ...
            {showPlusMenu && (
              <div
                ref={plusMenuRef}
                className="absolute bottom-full left-0 mb-2 w-48 rounded-xl border border-border bg-bg-secondary shadow-xl overflow-hidden z-30"
              >
                <button
                  onClick={() => { setShowPlusMenu(false); fileInputRef.current?.click() }}
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-text-secondary hover:bg-bg-hover hover:text-text-primary transition-colors cursor-pointer"
                >
                ...
                <button
                  onClick={() => { setShowPlusMenu(false); startRecording() }}
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-text-secondary hover:bg-bg-hover hover:text-text-primary transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <button
                  onClick={() => { setShowPlusMenu(false); setShowPollModal(true) }}
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-text-secondary hover:bg-bg-hover hover:text-text-primary transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
