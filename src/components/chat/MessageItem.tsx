...
import { useRoomStore as useRoomStoreGlobal } from '../../stores/roomStore'
...
function UserProfileCard({
  ...
  const setActiveRoom = useRoomStoreGlobal((s) => s.setActiveRoom)
  ...
  useEffect(() => {
    ...
    updatePosition()
    // Re-measure after card renders to get accurate height
  ...
  const statusLabel = presence === 'online' ? 'En ligne' : presence === 'unavailable' ? 'Absent' : 'Hors ligne'
